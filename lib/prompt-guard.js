...
const PROMPT_LEAK_PATTERNS = [
  ...
  /translate\s+(above|previous|earlier|the\s+above)/i,
  /repeat\s+(above|previous|everything|all|what\s+I\s+said)/i,
  /output\s+(above|previous|everything)/i,
  /print\s+(above|previous|everything)/i,
...
export function generateDeflectionResponse(mode = 'default') {
  const responses = {
    default: "我注意到你可能在询问我的工作方式。我是一位AI导师，专注于帮助你学习和理解新知识。我们可以讨论任何你想学习的主题，但我无法分享我的系统配置。你有什么想探索的领域吗？",
